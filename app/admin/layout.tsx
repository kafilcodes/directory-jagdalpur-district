        ...
        <div className="h-screen overflow-hidden bg-gray-50 flex">
            ...
            >
                <div className="flex flex-col h-full overflow-hidden">
                    ...
                    {/* Navigation */}
                    <ScrollArea className="flex-1 overflow-auto px-2 py-4">
                ...
                <Button
                    ...
                    size="icon"
                    onClick={() => setSidebarOpen(false)}
                    className="absolute top-3 right-3 lg:hidden h-8 w-8"
            ...
            {/* Main content with header for mobile trigger */}
            <main className="flex-1 h-full overflow-y-auto overflow-x-hidden">
                {/* Mobile menu trigger - Fixed position */}
                <div className="lg:hidden sticky top-0 z-30 bg-gray-50 px-4 py-3 flex items-center gap-3">
                    <Button
                        variant="outline"
                        size="icon"
                        onClick={() => setSidebarOpen(true)}
                        className="h-9 w-9 shadow-sm border-transparent hover:border-gray-300   "
                ...
                <div className={cn(
                    "container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-4 lg:py-8",
