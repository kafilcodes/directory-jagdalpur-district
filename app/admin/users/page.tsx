                    ...
                    {paginatedUsers.map((user) => (
                        <Card key={user.id} className="border-0 shadow-md hover:shadow-lg transition-shadow">
                            <CardContent className="p-6">
                                ...
                                {/* User ID (small) */}
                                <div className="mt-4 pt-4 border-t border-gray-100">
                                    <p className="text-xs text-gray-400 truncate" title={user.id}>
                                        ID: {user.id}
                                    </p>
                                </div>
                            </CardContent>
            ...
            <Card className="border-0 shadow-md hover:shadow-lg transition-shadow duration-300">
                <CardContent className="p-6">
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                        ...
                        <div className="space-y-1">
                            <p className="text-sm text-gray-600">With Listings</p>
                        ...
                        <div className="space-y-1">
                            <p className="text-sm text-gray-600">Avg. Listings/User</p>
                            <p className="text-2xl font-bold text-gray-900">
                                {users.length > 0
